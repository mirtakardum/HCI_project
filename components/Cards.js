    ...
    return(
        ...
        <div className="relative">
            ...
            <div className={`${selected === true ? "absolute mx-auto w-[80%] h-[90%] mt-8 inset-0 blur-md bg-babyblue rounded-lg" : "bg-dark"}`}></div>
                <div className={`relative mx-auto block w-80 h-80 rounded-lg shadowx cursor-pointer ${selected === true ? 'bg-babyblue' : 'bg-gradient-to-b from-gray-600 to-slate-900'}`} onClick={changeSelected}>
