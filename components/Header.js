        ...
        <>
            <nav className="flex justify-between items-center h-24 w-full mx-auto pl-4 pr-7 bg-light">
                ...
                <ul className="flex">
                    ...
                    <button type="button" className="text-gray-900 h-10 border-3 border-black hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 text-xl font-poppins font-extrabold rounded-lg px-5 text-center mr-2 my-4 dark:border-gray-600 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-800">SIGN IN</button>
                </ul>
                </div>
            </nav>
        </>
