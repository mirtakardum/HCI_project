    ...
    return(
        ...
        <nav className="flex justify-between items-center h-24 w-full mx-auto pl-9 pt-2 pr-7 bg-dark">
                ...
                <ul className="flex text-white text-center">
                    <li className="p-6 h-[100%] text-l hover:text-{color} cursor-pointer font-poppins font-bold">HOME</li>
                    <li className="p-6 h-[100%] text-l text-{color} cursor-pointer font-poppins font-bold">SERVICES</li>
                    <li className="p-6 h-[100%] text-l hover:text-{color} cursor-pointer font-poppins font-bold">PRICING</li>
                    <li className="p-6 h-[100%] text-l hover:text-{color} cursor-pointer font-poppins font-bold">ABOUT US</li>
                    <li className="p-6 h-[100%] text-l hover:text-{color} cursor-pointer font-poppins font-bold">BLOG</li>
                </ul>
                </div>
