...
function BlogCard({ title, description, image, authorName, authorPicture, authorTitle, tag }){
    return(
        ...
        <div className="mt-20 ml-10 lg:ml-20 w-80 lg:w-[768px] bg-white rounded-lg shadow-m">
            <div>
                <img className="rounded-t-lg h-46 lg:h-60 object-fill w-full" src={image} alt="" />
            </div>
            <div class="p-5">
                <a href="#">
                ...
                <div className="lg:flex justify-between">
                    ...
                    <button type="button" className="text-white bg-gradient-to-r from-blue-400 via-blue-500 to-blue-400 hover:bg-gradient-to-br shadow-lg font-medium rounded-lg text-m h-14 w-24 text-center mt-4 ml-24 lg:ml-0 mr-4">Read More</button>
                </div>
            </div>
        </div>
        </>
