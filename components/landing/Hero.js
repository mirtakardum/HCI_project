...
function Hero(){
    return(
        ...
        <motion.div
            ...
            className="absolute top-[17%] right-[12%] h-[20%] w-[13%] z-10 float-right bg-dark"></motion.div>
        ...
        <motion.div
            ...
            className="absolute top-[52%] right-[4%] h-[10%] w-[6%] float-right bg-dark"></motion.div>
        <motion.div 
            whileHover={{
                scale: 1.1,
                transition: {duration: 0.5}
            }}
            className="absolute top-[55%] left-[7%] h-[14%] w-[10%] float-right bg-dark"></motion.div>
