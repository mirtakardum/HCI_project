function Why(){
    return(
        <>
        <div className="bg-dark h-[100%] pt-10">
            <p className="mt-10 text-center text-white font-space font-bold text-7xl">Why Us?</p>
            <div className="flex mt-20 -ml-5 w-full justify-between">
                <div>
                ...
                <p className="mt-10 ml-14 w-[80%] text-white font-poppins text-l">Our team of experianced experts have dealt with some of the toughest
                ...
                <p className="mt-10 ml-14 w-[80%] text-white font-poppins text-l">MVK uses the worlds best hardware to achieve speeds no other competitor can match.
                    Be it video/image edditing, running some of the worlds largest neural networks or anything your business might need, MVK has the tools to do it.</p>
                </div>
                <div>
                ...
                <p className="mt-10 ml-14 w-[80%] text-white font-poppins text-l">Changed your business model and in need of new plans? No problem, MVK offers a
                ...
                <p className="mt-10 ml-14 w-[80%] text-white font-poppins text-l">Our track record speaks for itself. We've helped businesses of all sizes and
