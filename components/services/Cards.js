    ...
    return(
        ...
        <div className="relative">
            ...
            <div className={`${selected === true ? "absolute ml-2 lg:mx-auto w-[100%] lg:w-[80%] lg:h-[90%] mt-8 inset-0 blur-md bg-babyblue rounded-lg" : "bg-dark"}`}></div>
                <div className={`relative mx-auto block w-36 h-36 lg:w-80 lg:h-80 rounded-lg shadowx cursor-pointer ${selected === true ? 'bg-babyblue' : 'bg-gradient-to-b from-gray-600 to-slate-900'}`} onClick={changeSelected}>
